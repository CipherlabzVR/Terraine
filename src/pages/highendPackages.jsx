...
const packageDetails = {
  ...
  subtitle: '“Strong foundations for Sustainable future growth.”',
  ...
  idealFor: 'Government and Private Projects, Contractors, Road & Utility Developers, Business Organizations',
  includes: [
    'Engineering Consulting',
    'BIM (3D – 9D) Integration to the whole Project',
    'Drone Surveying & Digital Mapping',
    ...
    'Construction (Roads, Bridges, Highways, Utilities, Vehicle parking Areas, and etc.)',
    'Sub-Construction',
...
const InfrastructurePackage = () => {
  ...
  const images = [gold1, gold2, gold3, gold4, gold5]; // TODO: Replace with relevant images
          ...
          <div className="relative w-full h-full overflow-hidden border-2 border-white/10 bg-black/40 shadow-2xl">
            ...
            <div className="relative w-full h-full overflow-hidden">
              ...
              <img
                ...
                alt="Infrastructure project designs"
...
export default InfrastructurePackage;