...
const packageDetails = {
  ...
  subtitle: '“Smart spaces for Thriving Businesses”',
  ...
  idealFor: 'Businesses, Retail Chains, Office Developers, Hotels, Showrooms, Shopping Complex, Universities and Institutes, Hospitals and Special Laboratories, Apartment Builders, Tourist attraction Vilas and Cabanas',
  includes: [
    'Investment to ROI Consultancy',
    'Engineering Consultancy',
    'Bank loan Facility',
    'Land Selection',
    'Field and Laboratory Testing',
    'Architectural Drawings, Land Filling and other Government bodies of necessary Approvals',
    'Architectural, Structural, MEP and HVAC Drawings',
    'BIM (3D – 9D) Integration to the whole Project',
    'Smart Project Planning & Management',
    'Material Selection & Sustainable Consultancy',
    'Interior Design',
    'Visual Reality (VR) of the Project',
    'Landscaping and Gardening',
    'AI-Powered Design Consultation',
    'Construction (Concrete/ Timber/ Steel/ Cladding/ Aluminum fabrication)',
    'Precast construction',
    'Sub-construction',
    'Construction Material Supply',
    'Import of Specialized Construction Materials, Machineries and tools, Interior Fittings & Furniture',
    'Customized Smart Furniture Design',
          ...
          <div className="relative w-full h-full overflow-hidden border-2 border-white/10 bg-black/40 shadow-2xl">
            ...
            <div className="relative w-full h-full overflow-hidden">
              ...
              <img
                ...
                alt="Commercial project designs"
