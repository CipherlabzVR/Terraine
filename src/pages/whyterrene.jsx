              ...
              <div className="flex flex-col justify-start p-0 pt-0 pb-8 lg:pb-11 xl:pb-16 bg-gradient-to-r from-cyan-600 to-[#0b2741] rounded-3xl  relative overflow-hidden shadow-2xl lg:ml-0 lg:-mr-16 mt-0 lg:mt-0">
                ...
                <div className="relative z-10 flex flex-col items-start h-full px-4 sm:px-8 lg:px-11 xl:px-16 pt-8">
                  ...
                  <div className="w-full">
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-6 text-left">Our Advantages</h2>
                    <ul className="space-y-4 max-w-4xl">
                      ...
                      <li>
                        ...
                        >
                          <span className="text-lg sm:text-xl font-semibold text-white">Technical Expertise</span>
                          <ChevronDown 
                      ...
                      <li>
                        ...
                        >
                          <span className="text-lg sm:text-xl font-semibold text-white">Client-Centered Approach</span>
                          <ChevronDown 
                            className={`w-6 h-6 text-white transition-transform duration-200 ${
                      ...
                      <li>
                        ...
                        >
                          <span className="text-lg sm:text-xl font-semibold text-white">Sustainable Solutions</span>
                          <ChevronDown 
                            className={`w-6 h-6 text-white transition-transform duration-200 ${
