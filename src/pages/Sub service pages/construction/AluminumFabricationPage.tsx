...
import { aluminumFabricationPageData } from '../../../sub-service-data/construction/aluminumFabricationData';

// --- IMPORTANT ---
// The keys used here (e.g., 'scopeImage') MUST match the keys in your data file.

// Standardized scope and testimonial images from the 'construction' folder
import scopeImage from '/Aluminum Fabrication.jpg'; 
...
const AluminumFabricationPage = () => {
  return (
    <SubServicePageLayout 
      pageData={aluminumFabricationPageData} 
      imageAssets={imageAssets}
    />
  );
};

export default AluminumFabricationPage;