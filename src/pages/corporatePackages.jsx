...
const Crystal    = new URL('../assert/Packages/Crystal.png', import.meta.url).href;
const corporate1 = new URL('../assert/Packages/corporate/corporate1.png', import.meta.url).href;
const corporate2 = new URL('../assert/Packages/corporate/corporate2.png', import.meta.url).href;
const corporate3 = new URL('../assert/Packages/corporate/corporate3.png', import.meta.url).href;
const corporate4 = new URL('../assert/Packages/corporate/corporate4.jpg', import.meta.url).href;
const corporate5 = new URL('../assert/Packages/corporate/corporate5.jpg', import.meta.url).href;
...
const packageDetails = {
  ...
  idealFor:
    'Medium-Scale to Large-Scale Developers, Smart City Projects, Contractors, Engineering Consulting Firms, Individuals who requires Latest Engineering technology integration to any type of Projects to Maximize the efficiency and reduce the cost and maintain sustainability',
  includes: [
...
const BimAiPackage = () => {
  ...
  const images = [corporate1, corporate2, corporate3, corporate4, corporate5];
              ...
              <div className="flex flex-col justify-start p-0 pt-0 pb-1 lg:pb-1 xl:pb-4 bg-gradient-to-r from-cyan-600 to-[#0b2741] rounded-3xl  relative overflow-hidden shadow-2xl ml-0 lg:ml-0 lg:-mr-16 mt-0 lg:mt-0">
                ...
                <div className="relative z-10 flex flex-col items-start h-full px-8 lg:px-11 xl:px-16 pt-8">
                  ...
                  <div className="mt-4 flex justify-center w-full">
                    <Button
                      size="lg"
                      className="bg-[#0050A0] text-white hover:bg-white/30 text-lg px-8 py-6 font-semibold"
                    >
