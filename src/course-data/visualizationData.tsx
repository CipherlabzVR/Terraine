...
export const visualizationData = {
  meta: {
    title: "Master Diploma in 3D Visualization with VR | Terrene Engineering ", // [cite: 1]
    description: "Master 3D visualization & VR with Terrene Engineering. Learn to design realistic models and immersive experiences for architecture & engineering" // [cite: 1]
  },
  // --- Hero Section ---
