  ...
  return (
    <section className="py-16 md:py-20 w-full relative">
      ...
      <div className="w-full max-w-9xl mx-auto px-4 md:px-8 relative z-20">
        <div
          className="bg-gradient-to-r from-cyan-700 to-[#0b2741] rounded-2xl  p-4 sm:p-8 md:p-12 relative overflow-hidden shadow-2xl"
        >
            ...
            <div className="w-full overflow-hidden">
              <div className="flex justify-center items-center gap-2 sm:gap-4 md:gap-8 transition-all duration-500 ease-in-out">
                {currentLogos.map((item, idx) => (
                  <div
                    key={`${item.index}-${idx}`}
                    className="flex-shrink-0 flex items-center justify-center h-20 w-24 sm:h-24 sm:w-32 md:h-28 md:w-44 transform transition-all duration-500 hover:scale-105"
                  >
                    <img
                      src={item.logo}
