          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16">
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  through professional expertise, cutting-edge technology, and collaborative partnerships                 </p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  safer, and more sustainable communities worldwide                 </p>
              </div>
            </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      transparency, and honesty in all our professional relationships                     </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      complex engineering challenges and improve project outcomes                     </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      continuously improving our processes and delivering superior results                     </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      solutions that minimize environmental impact for future generations                     </p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-primary/10 to-blue-50 rounded-lg p-8 text-center">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                ...
                trust, reliability, and exceptional service delivery. Your success is our success               </p>
            </div>
          </div>
        </div>
      </main>
