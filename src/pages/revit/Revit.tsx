          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                ...
                <p className="text-muted-foreground">
                  Comprehensive 3D building information models                 </p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                <Database className="w-12 h-12 text-primary mx-auto mb-4" />
                <h3 className="text-xl font-semibold mb-2">Data Management</h3>
                <p className="text-muted-foreground">
                  Intelligent data integration and project coordination                 </p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                <Share2 className="w-12 h-12 text-primary mx-auto mb-4" />
                <h3 className="text-xl font-semibold mb-2">Collaboration</h3>
                <p className="text-muted-foreground">
                  Enhanced team collaboration and project coordination                 </p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 rounded-lg p-8 text-center">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                ...
                and seamless project coordination across all disciplines               </p>
