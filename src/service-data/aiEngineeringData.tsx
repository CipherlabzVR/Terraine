...
export const aiEngineeringPageData: PageData = {
  ...
  about: {
    ...
    description: "Delivering cutting-edge AI engineering solutions that blend advanced technology with intelligent problem-solving. Our approach harnesses artificial intelligence to optimize systems, enhance decision-making, and drive innovative, data-driven sustainable outcomes.",
    button: { text: "OUR TECHNOLOGY", link: "/about" },
    images: {
      main: "aiMainImage",
      secondary: "aiSecondaryImage"
    },
    stat: {
      value: "30%",
  ...
  workingSteps: {
    ...
    steps: [
      { icon: "ClipboardList", title: "Requirement Analysis", description: "Understand your goals and challenges to create tailored AI strategies." },
      { icon: "PenTool", title: "AI Solution Integrated Design", description: "Develop intelligent, innovative AI systems for design, planning, and construction optimization." },
      { icon: "Plug", title: "Implementation & Integration", description: "Seamlessly integrate AI with workflows for maximum efficiency and automation." },
      { icon: "ShieldCheck", title: "Lifetime Support & Updates", description: "Receive continuous updates, optimization, and lifetime support for AI integrated sustainable projects." }
    ],
    backgroundImage: "/blueprint-bg.png"
  },
  // TODO: Update the placeholder data below with your specific AI Engineering projects.
  projects: {
    superTitle: "CASE STUDIES",
    title: "AI Engineering in Action",
    list: [
      { image: "/pro37.png", name: "AI-Optimized Cooperate Office" },
      { image: "/pro45.png", name: "Central Transit Hub" },
      { image: "/pro81.png", name: "Aurora Sky Tower" },
      { image: "/pro (13).png", name: "AI-Enhanced Auditorium" },
      { image: "/pro (85).png", name: "NeoSpire Tower" },
  ...
  testimonials: {
    ...
    title: "Global Praise for Our AI Engineering Services",
    list: [
    ...
    featuredImage: "aiTestimonialImage",
    videoBackground: "aiTestimonialsVideo"
  }
};
