...
import { specializedEngineeringProductsPageData } from '../../../sub-service-data/import-export/specializedEngineeringProductsData';
...
const SpecializedEngineeringProductsPage = () => {
  return (
    <SubServicePageLayout 
      pageData={specializedEngineeringProductsPageData} 
      imageAssets={imageAssets}
    />
  );
};

export default SpecializedEngineeringProductsPage;
