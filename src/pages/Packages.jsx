...
const packageData = [
	{
		...
		details: 'Ideal For: Homeowners, Property Developers, Housing Societies, Apartments, Vila, Cabanas',
	},
	{
		...
		description: 'Maximize investment and operational efficiency with our Commercial Project Package. From concept to completion, we deliver intelligent, sustainable, and high-performing commercial spaces tailored for long-term success.',
		details: 'Ideal For: Businesses, Retail Chains, Office Developers, Hotels, Showrooms, Shopping Complex, Universities and Institutes, Hospitals and Special Laboratories, Apartment Builders, Tourist attraction Vilas and Cabanas',
	},
	{
		...
		description: 'Our Infrastructure Project Package builds robust, reliable, and future-ready Sustainable public and private assets. Advanced engineering, precise planning, and cutting-edge technology ensure every project exceeds expectations.',
		details: 'Ideal For: Government and Private Projects, Contractors, Road & Utility Developers, Business Organizations',
	},
	{
		...
		description: 'Drive projects forward with expert guidance across design, management, implementation and maintenance. Our package ensures smart planning, innovative solutions, regulatory compliance, and sustainable results at every stage',
		details: 'Ideal For: Developers, Contractors, Institutions needing Technical Guidance, Individuals who requires Engineering Consulting to their any type of projects to Manage Quality, Budget and Project Time',
	},
	{
		...
		details: 'Ideal For: Medium-Scale to Large-Scale Developers, Smart City Projects, Contractors, Engineering Consulting Firms, Individuals who requires Latest Engineering technology integration to any type of Projects to Maximize the efficiency and reduce the cost and maintain sustainability',
	},
	{
		...
		description: 'Empower with advanced technical skills and hands-on training. Our Software & Skills Training Package equips students and professionals with modern tools, practical knowledge, and innovative sustainable strategies for real-world applications.',
		details: 'Ideal For: Students, undergraduates, Engineers, Project Managers, BIM Specialists, Draftsmen, Interior Designers and Engineering Skill seekers and AEC Professionals',
	},
];
        ...
        <div className="min-h-screen bg-[#0b2741]">
			...
			<main id="packages-grid" className="relative py-16 md:py-24">
				<div className="w-full max-w-[2400px] mx-auto px-5 md:px-9 lg:px-14 relative z-20">
					{/* --- ROW 1: Previous changes maintained --- */}
							...
							>
								...
								<div className="relative z-10 flex flex-col flex-grow p-6">
									<div className='flex-grow flex flex-col'>
										...
										<p className="w-full text-cyan-300 italic text-lg text-center mb-8">
											“{pkg.tagline}”
										</p>
							...
							>
								...
								<div className="relative z-10 flex flex-col flex-grow p-6">
									<div className='flex-grow flex flex-col'>
                                        ...
                                        {/* ✅ FIX: Added fixed height 'h-32' to align the start of every 'Ideal For' box */}
										<p className="text-white/90 mb-10 text-lg h-32">
											{pkg.description}
										</p>
										<div className="bg-black/20 p-4 rounded-lg border border-white/10 mb-6 flex-grow">
											<p className="text-md text-white/80">
