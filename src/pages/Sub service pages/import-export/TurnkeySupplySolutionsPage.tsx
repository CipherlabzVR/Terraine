...
import { turnkeySupplySolutionsPageData } from '../../../sub-service-data/import-export/turnkeySupplySolutionsData';
...
import projectImg1 from '../../../assert/projects/pro33.png';
import projectImg2 from '../../../assert/projects/pro6.png';
import projectImg3 from '../../../assert/projects/pro73.png';
import projectImg4 from '../../../assert/projects/pro45.png';
...
const TurnkeySupplySolutionsPage = () => {
  return (
    <SubServicePageLayout 
      pageData={turnkeySupplySolutionsPageData} 
      imageAssets={imageAssets}
    />
  );
};

export default TurnkeySupplySolutionsPage;
