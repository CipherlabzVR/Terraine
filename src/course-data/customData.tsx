...
export const customizedTrainingData = {
  meta: {
    title: "Customized Professional Training | Terrene Engineering",
    description: "Terrene Engineering offers customized professional training, empowering teams with tailored programs to enhance skills, efficiency & expertise"
  },
  // --- Hero Section ---
