...
// ✅ Image resolves (no renames). Uses relative path from /src/pages → /src/assert/...
// If your actual file is White.png (capital W), change 'white.png' to 'White.png' below.
const white  = new URL('../assert/Packages/white.png', import.meta.url).href;
//const White  = white;   // keep compat if JSX used `White`
const silver = white;   // your JSX uses `src={silver}` → map it to the same image

const diamond1 = new URL('../assert/Packages/Diamond/Diamond1.png', import.meta.url).href;
const diamond2 = new URL('../assert/Packages/Diamond/Diamond2.png', import.meta.url).href;
const diamond3 = new URL('../assert/Packages/Diamond/Diamond3.png', import.meta.url).href;
const diamond4 = new URL('../assert/Packages/Diamond/Diamond4.png', import.meta.url).href;
const diamond5 = new URL('../assert/Packages/Diamond/Diamond5.png', import.meta.url).href;

const packageDetails = {
  name: 'Engineering Consulting Package',
  subtitle: '“Expert insights for Engineering Excellence”',
  description: 'Drive projects forward with expert guidance across design, management, implementation and maintenance. Our Engineering Consulting Package ensures smart planning, innovative solutions, regulatory compliance, and sustainable results at every stage.',
  idealFor: 'Developers, Contractors, Institutions needing Technical Guidance, Individuals who requires Engineering Consulting to their any type of projects to Manage Quality, Budget and Project Time',
  includes: [
    'Smart Project Management & Planning',
    'Cost & Value Engineering Solutions',
    'Structural Engineering Consultancy',
    'Architectural & Interior Design Consultancy',
    'Landscape and Gardening Consulting',
    'MEP & HVAC System Design Consultancy',
    'BIM & Digital Twin Consultancy',
    'Material Selection, Testing & Certification Consultancy',
    'Customized Smart Furniture Design Consultancy',
    ...
    'AI-Powered Design & Predictive Analytics',
    'Construction Supervision & QA/QC',
    'Import and Export consultancy',
    'Procurement Advisory for Materials, Tools & Equipment',
    'Project Maintenance Consultancy',
    'Customized Corporate Training'
  ],
  benefits: []
};

const EngineeringConsultingPackage = () => {
  const [showHeader, setShowHeader] = useState(true);
  const lastScrollY = useRef(0);
  const [currentImage, setCurrentImage] = useState(0);
  const images = [diamond1, diamond2, diamond3, diamond4, diamond5]; // TODO: Replace with relevant images
          ...
          <div className="relative w-full h-full overflow-hidden border-2 border-white/10 bg-black/40 shadow-2xl">
            ...
            <div className="relative w-full h-full overflow-hidden">
              ...
              <img
                ...
                alt="Engineering project visuals"
...
export default EngineeringConsultingPackage;