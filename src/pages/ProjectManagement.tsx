          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                ...
                <p className="text-muted-foreground">
                  Efficient scheduling and milestone tracking for project success                 </p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                <Users className="w-12 h-12 text-primary mx-auto mb-4" />
                <h3 className="text-xl font-semibold mb-2">Team Coordination</h3>
                <p className="text-muted-foreground">
                  Seamless coordination between all project stakeholders                 </p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                <Target className="w-12 h-12 text-primary mx-auto mb-4" />
                <h3 className="text-xl font-semibold mb-2">Quality Assurance</h3>
                <p className="text-muted-foreground">
                  Rigorous quality control and project delivery standards                 </p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 rounded-lg p-8 text-center">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                ...
                efficiently, safely, and within budget constraints               </p>
