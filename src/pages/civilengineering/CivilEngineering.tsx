          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  ...
                  to comprehensive site development, we deliver solutions that last                 </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                ...
                <p className="text-muted-foreground">
                  Road design, traffic management, and transportation planning solutions                 </p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                <Droplets className="w-12 h-12 text-primary mx-auto mb-4" />
                <h3 className="text-xl font-semibold mb-2">Water Systems</h3>
                <p className="text-muted-foreground">
                  Water supply, drainage, and sewerage system design and implementation                 </p>
              </div>
              <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                <Building className="w-12 h-12 text-primary mx-auto mb-4" />
                <h3 className="text-xl font-semibold mb-2">Infrastructure</h3>
                <p className="text-muted-foreground">
                  Bridges, culverts, and major infrastructure development projects                 </p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 rounded-lg p-8 text-center">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                ...
                development needs. Contact us for a consultation and project assessment               </p>
