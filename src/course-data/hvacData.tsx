...
export const mepHvacData = {
  meta: {
    title: " Master Diploma in MEP and HVAC Systems | Terrene Engineering ", // [cite: 1]
    description: "Our Master Diploma in MEP & HVAC trains you to design, model & optimize building systems for high-performance projects." // [cite: 1]
  },
  // --- Hero Section ---
