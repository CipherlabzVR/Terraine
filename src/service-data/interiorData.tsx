...
export const interiorDesignPageData: PageData = {
  hero: {
    ...
    description: "Creating inspiring interiors with concept design, turnkey solutions, furniture selection, styling, and decor that perfectly reflect your sustainable vision, lifestyle, and unique style.",
    backgroundImage: "/int.webp",
    buttons: [
  ...
  about: {
    ...
    description: "Our interior design services create inspiring, functional, and elegant spaces that reflect your style, enhance comfort, and elevate experiences, blending creativity and practicality to transform every area into a masterpiece.",
    button: { text: "OUR APPROACH", link: "/about" },
    images: {
      main: "interiorMainImage",
      secondary: "interiorSecondaryImage"
    },
    stat: {
      value: "100+",
  ...
  projects: {
    ...
    title: "Inspiring Interior Spaces",
    list: [
      { image: "/pro53.png", name: "Luxury Villa Interior" },
      { image: "/11.jpg", name: "Modern Office Space" },
      { image: "/4.jpg", name: "Modern Home" },
      { image: "/12.jpg", name: "Chic Retail Store" },
      { image: "/8.jpg", name: "Minimalist Apartment" },
  ...
  testimonials: {
    ...
    title: "Global Praise for Our Designs",
    list: [
  ...
  summary: {
    ...
    featuredImage: "interiorTestimonialImage",
    videoBackground: "interiorTestimonialsVideo"
  }
};
