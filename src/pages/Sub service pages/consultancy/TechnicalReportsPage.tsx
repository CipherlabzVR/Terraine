...
import { technicalReportsPageData } from '../../../sub-service-data/consultancy/technicalReportsData';

// --- IMPORTANT ---
// The keys used here (e.g., 'scopeImage') MUST match the keys in your data file.

// Standardized scope image as requested
import scopeImage from '../../../assert/Sub Services/consultancy/consultancy-testimonial-16.jpg'; 
import testimonialImage from '../../../assert/Sub Services/consultancy/consultancy-testimonial-16.jpg';
...
const TechnicalReportsPage = () => {
  return (
    <SubServicePageLayout 
      pageData={technicalReportsPageData} 
