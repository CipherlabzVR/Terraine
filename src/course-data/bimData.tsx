...
export const bimData = {
  meta: {
    title: "Master Diploma in BIM | Terrene Engineering", // [cite: 1]
    description: "Terrene Engineering offers a Master Diploma in BIM, equipping you with skills in digital modeling, collaboration, and modern construction workflows" // [cite: 1]
  },
  // --- Hero Section ---
