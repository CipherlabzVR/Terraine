        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            ...
            >
              ...
              <p className="text-muted-foreground">
                Creative architectural design from concept sketches to detailed development drawings that bring your vision to life               </p>
            </div>
            <div
              className="bg-gradient-to-r from-cyan-500 to-blue-700 rounded-lg shadow-lg p-8 text-center hover:shadow-2xl transition-shadow transform hover:-translate-y-2 duration-300 animate-section-fade"
            ...
            >
              ...
              <p className="text-muted-foreground">
                Optimal utilization of available space with functional layouts designed for efficiency and comfort               </p>
            </div>
            <div
              className="bg-gradient-to-r from-cyan-500 to-blue-700 rounded-lg shadow-lg p-8 text-center hover:shadow-2xl transition-shadow transform hover:-translate-y-2 duration-300 animate-section-fade"
            ...
            >
              ...
              <p className="text-muted-foreground">
                Environmentally responsible architecture that minimizes ecological footprint while maximizing resource efficiency               </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 mb-20">
            ...
            <div className="bg-gradient-to-r from-cyan-500 to-blue-700 rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  A luxury residential complex featuring sustainable design principles and modern aesthetics                 </p>
            ...
            <div className="bg-gradient-to-r from-cyan-500 to-blue-700 rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  A state-of-the-art commercial building with innovative workspace design and energy-efficient systems                 </p>
                <div className="flex flex-wrap gap-2 mb-4">
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="flex flex-col items-center text-center p-6">
                ...
                <p className="text-muted-foreground">
                  Over 15 years of experience delivering exceptional architectural solutions across diverse projects                 </p>
              </div>
              <div className="flex flex-col items-center text-center p-6">
                <Users className="h-12 w-12 text-primary mb-4" />
                <h3 className="text-xl font-semibold mb-3">Collaborative Approach</h3>
                <p className="text-muted-foreground">
                  We work closely with clients and stakeholders to ensure designs meet and exceed expectations                 </p>
              </div>
              <div className="flex flex-col items-center text-center p-6">
                <Building className="h-12 w-12 text-primary mb-4" />
                <h3 className="text-xl font-semibold mb-3">Sustainable Focus</h3>
                <p className="text-muted-foreground">
                  Commitment to environmentally responsible design principles that stand the test of time                 </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-primary text-white rounded-lg p-10 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              ...
              innovative design solutions that exceed expectations             </p>
