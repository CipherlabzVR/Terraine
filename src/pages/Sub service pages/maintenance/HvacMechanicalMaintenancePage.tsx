...
import { hvacMechanicalMaintenancePageData } from '../../../sub-service-data/maintenance/hvacMechanicalMaintenanceData';
...
import testimonialImage from '../../../assert/Sub Services/maintenance/Maintenance-testimonials-9.jpg';
...
const HvacMechanicalMaintenancePage = () => {
  return (
    <SubServicePageLayout 
      pageData={hvacMechanicalMaintenancePageData} 
      imageAssets={imageAssets}
    />
  );
};

export default HvacMechanicalMaintenancePage;