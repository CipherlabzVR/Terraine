// Suggested Filename: DetailedDrawings.tsx

import React from 'react';
import SubServicePageLayout from '../../SubServicePageLayout';
import { detailedDrawingsPageData } from '../../../sub-service-data/interior/detailedDrawingsData';
...
import testimonialImage from '../../../assert/Sub Services/interior/Interior-testimonials-6.jpg';
...
const DetailedDrawingsPage = () => {
  return (
    <SubServicePageLayout 
      pageData={detailedDrawingsPageData} 
      imageAssets={imageAssets}
    />
  );
};

export default DetailedDrawingsPage;