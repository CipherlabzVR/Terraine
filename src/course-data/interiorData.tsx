...
export const interiorDesignData = {
  meta: {
    title: "Master Diploma in Interior Design | Terrene Engineering",
    description: "Advance your career with our Interior Design Diploma. Develop skills to design functional, aesthetic & creative spaces for modern living"
  },
  // --- Hero Section ---
